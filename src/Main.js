...
function Main() {
    ...
    useEffect(() => {
        fetch("https://mobilestore-papi.onrender.com/commerce")
            .then((res) => {
                return res.json()
            })
            .then((resp) => {
    ...
    const search = async (event) => {
        event.preventDefault()
        return await axios.get(`https://mobilestore-papi.onrender.com/commerce?q=${value}`)
            .then((res) => {
                setData(res.data)
                setValue("")
            })
    ...
    const sorting = async (e) => {
        ...
        setSort(value)
        return await axios.get(`https://mobilestore-papi.onrender.com/commerce?_sort=${value}&_order=asc`)
            .then((res) => {
                setData(res.data)
            })
            .catch((err) => {
    ...
    const adddata = (id) => {
        fetch("https://mobilestore-papi.onrender.com/commerce/" + id)
            .then((res) => {
                return res.json()
            })
            .then((resp) => {
                console.log(resp)
                fetch("https://mobilestore-papi.onrender.com/cart", {
                    method: "POST",
