            ...
            <div id="blur" >
                ...
                <form onSubmit={submitData} >
                    ...
                    <div>
                        ...
                        <br></br>
                        <input  id="in"  type="text" required placeholder="enter your full name"   value={name} onChange={e => setName(e.target.value)}  ></input>
                    </div>
                    <div>
                        <br></br>
                    ...
                    <div>
                        ...
                        <br></br>
                        <input id="in"  type="password" required placeholder="confirm-password" value={cpswd} onChange={e => setCpswd(e.target.value)}  ></input>
                    </div>
                    <br></br>

                    <button id="re" type="submit" class="btn btn-primary" style={{ }}>Register</button>
                </form>

                <br></br>
                <a><b>If you have an account</b>
                    <Link to="/Login" style={{ textDecorationLine: "none", marginLeft: "10px", fontSize: "larger", color: "white" }}>Login here</Link>
                </a>
